...
fn main() {
    ...
    res.set("FileDescription", "ZeroNode VPN client CLI");
    res.set("InternalName", "vpnctl");
    res.set("OriginalFilename", "vpnctl.exe");
    res.set(
        "Comments",
        "ZeroNode VPN CLI requiring admin elevation for host and tunnel setup",
    );
