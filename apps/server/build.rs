...
fn main() {
    ...
    res.set("FileDescription", "ZeroNode VPN server control daemon");
    res.set("InternalName", "vpn-server");
    res.set("OriginalFilename", "vpn-server.exe");
    res.set("Comments", "ZeroNode VPN server daemon requiring admin elevation for service, firewall, and tunnel setup");
